...
export const SignUpPage = () => {
	...
	return (
		<div className="container rounded m-5 bg-body-secondary">
			...
			{authFail && <p className="text-warning">Email is already in use, please choose another.</p>}
			<button onClick={handleSubmit} type="submit" className="btn btn-primary m-3">
				Sign Up
			</button>
		</div>
	);
